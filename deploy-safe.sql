-- ============================================================
-- DEPLOY-SAFE.sql — Migrations Sprint 1 (idempotent)
-- ============================================================
-- Les ALTER TABLE ignorent les erreurs si la colonne existe déjà
-- Les CREATE TABLE IF NOT EXISTS sont naturellement idempotents
-- ============================================================

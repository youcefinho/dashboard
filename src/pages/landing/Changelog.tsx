    ...
    <PublicLayout>
      <div className="pt-20 pb-24 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto">
        {isLoading ? (
          ...
          <article className="prose prose-slate max-w-none prose-headings:text-slate-900 prose-a:text-[var(--brand-primary)] prose-h1:text-4xl prose-h1:font-extrabold prose-h1:mb-8">

    ...
    <PublicLayout>
      <div className="pt-20 pb-24 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-extrabold text-slate-900 mb-4">Réservez votre démo</h1>
        ...
        <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 text-center">
          <div className="aspect-video bg-slate-50 border border-slate-100 rounded-xl mb-8 flex items-center justify-center">
            {/* Embed Calendly Placeholder */}
            <p className="text-slate-500 font-medium">Ici sera intégré le widget Calendly d'Intralys</p>
          </div>

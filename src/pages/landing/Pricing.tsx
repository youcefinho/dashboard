    ...
    <PublicLayout>
      <div className="pt-20 pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-extrabold text-slate-900 mb-4">Des tarifs simples et transparents</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 flex flex-col">
            ...
            <p className="text-slate-500 text-sm mb-6">Pour les solos et petites équipes qui démarrent.</p>
            <div className="mb-6">
              <span className="text-4xl font-extrabold text-slate-900">47$</span>
          ...
          <div className="bg-white rounded-2xl border-2 border-[var(--brand-primary)] shadow-md p-8 flex flex-col relative">
            ...
            <p className="text-slate-500 text-sm mb-6">Pour les entreprises en croissance qui veulent automatiser.</p>
            <div className="mb-6">
              <span className="text-4xl font-extrabold text-slate-900">97$</span>
              <span className="text-slate-500">/mois</span>
            </div>
            <Link to="/demo" className="mt-auto mb-8">
          ...
          <div className="bg-white rounded-2xl border border-slate-200 shadow-sm p-8 flex flex-col">
            ...
            <p className="text-slate-500 text-sm mb-6">Pour les agences et grandes équipes avec besoins avancés.</p>
            <div className="mb-6">
